...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0 d-flex align-items-center">
            @include('partials.record-navigation', ['route' => 'kaprodi.lecturers.manage.show'])
            <div class="ms-3 d-flex">
                <a href="{{ route('kaprodi.lecturers.manage.index', request()->query()) }}"
                    class="btn btn-outline-secondary shadow-none">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
                <a href="{{ route('kaprodi.lecturers.manage.edit', $lecturer) }}" class="btn btn-primary shadow-none">
