...
@section('title', 'Tambah Rubrik Penilaian')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah Rubrik Baru</h1>
    ...
    <form action="{{ route('kaprodi.rubrics.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                value="{{ old('name') }}" required placeholder="Contoh: Rubrik Sidang Akhir">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                placeholder="Deskripsi singkat rubrik...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-check-circle me-1"></i> Simpan Rubrik
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div id="criteria-container">
                            @php $criteria = old('criteria', [['name' => '', 'weight' => '', 'description' => '']]); @endphp
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 mb-3">
                                            ...
                                            <input type="text" name="criteria[{{ $index }}][name]"
                                                ...
                                                required placeholder="Contoh: Orisinalitas Ide">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="criteria[{{ $index }}][description]" class="form-control form-control-sm" rows="2"
                                                placeholder="Penjelasan singkat kriteria...">{{ $criterion['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
