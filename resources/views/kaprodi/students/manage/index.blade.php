                            ...
                            @forelse($students as $student)
                                <tr>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group">
                                            <a href="{{ route('kaprodi.students.manage.show', array_merge(['manage' => $student->id], request()->query())) }}"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="{{ route('kaprodi.students.manage.edit', array_merge(['manage' => $student->id], request()->query())) }}"
                                                class="btn btn-sm btn-outline-warning">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form action="{{ route('kaprodi.students.manage.destroy', $student) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
