...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('student.submissions.update', $submission) }}" 
                      method="POST" 
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Judul Tugas Akhir <span class="text-danger">*</span></label>
                        <input type="text" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               class="form-control @error('research_field') is-invalid @enderror" 
                               id="research_field" 
                               name="research_field" 
                               value="{{ old('research_field', $submission->research_field) }}"
                               maxlength="100">
                        ...
                        <select class="form-select @error('supervisor_id') is-invalid @enderror" 
                            ...
                            @foreach($supervisors as $supervisor)
                                <option value="{{ $supervisor->id }}" 
                                        {{ old('supervisor_id', $submission->supervisor_id) == $supervisor->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        <label for="proposal_file" class="form-label">Upload File Baru (Opsional)</label>
                        <input type="file" 
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="small">
                    Anda hanya dapat mengedit pengajuan dengan status <strong>Draft</strong> atau <strong>Perlu Revisi</strong>.
                </p>
                <hr>
