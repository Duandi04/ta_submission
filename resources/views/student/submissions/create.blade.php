            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('student.submissions.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-4">
                            <label class="form-label d-block">Metode Upload File Proposal <span
                                    class="text-danger">*</span></label>
                        ...
                        <div id="drive_upload_section" style="{{ old('upload_type') === 'drive' ? '' : 'display: none;' }}">
                            <div class="mb-3">
                                <label class="form-label">File dari Google Drive <span class="text-danger">*</span></label>
                                <div class="d-grid">
                                ...
                                @enderror
                                <small class="text-muted d-block mt-1">Data akan diunduh ke server kami untuk keperluan
                                    evaluasi.</small>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        // Toggle sections based on upload type
        document.querySelectorAll('input[name="upload_type"]').forEach(radio => {
            radio.addEventListener('change', (e) => {
                if (e.target.value === 'local') {
                    ...
                    document.getElementById('proposal_file').required = true;
                } else {
                    ...
                    document.getElementById('proposal_file').required = false;
                }
            });
        });
        ...
        googlePickerBtn.addEventListener('click', () => {
            ...
            if (accessToken === null) {
                // Request a time-limited access token
