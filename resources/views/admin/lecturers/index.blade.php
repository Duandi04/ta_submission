...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.lecturers.create') }}" class="btn btn-primary shadow-none">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form action="{{ route('admin.lecturers.index') }}" method="GET" class="row g-3">
                <div class="col-md-6">
                            ...
                            @forelse($lecturers as $lecturer)
                                <tr>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.lecturers.show', array_merge(['lecturer' => $lecturer->id], request()->query())) }}"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.lecturers.edit', array_merge(['lecturer' => $lecturer->id], request()->query())) }}"
