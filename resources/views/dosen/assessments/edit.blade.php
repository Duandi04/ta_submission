                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="comments" class="form-control form-control-sm" rows="3"
                                placeholder="Tuliskan komentar umum...">{{ old('comments', $assessment->comments) }}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="strengths" class="form-control form-control-sm" rows="2"
                                placeholder="Tuliskan kelebihan...">{{ old('strengths', $assessment->strengths) }}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="weaknesses" class="form-control form-control-sm" rows="2"
                                placeholder="Tuliskan kelemahan...">{{ old('weaknesses', $assessment->weaknesses) }}</textarea>
                        </div>
                        <div class="mb-3">
